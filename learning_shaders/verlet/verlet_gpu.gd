...
"
size of the simualtion matters !!!
higher gravity on smaller particles increases the chances of destabilizations. 
...
func init_compute():
	...
	# Load compute shader
	var shader_file : RDShaderFile = load("res://verlet/PBD2.glsl")
...
#
	...
	var buffers = [storage_uniform, params_uniform, pos_uniform, particles_uniform, write_only_uniform, col_data_uniform, counter_buffer_uniform]
